<template>
  <div>
          ...
          <div class="hot-offer__hover">
            <div class="hot-offer__square">
              <button name="add" @click="add(item)">
                <img src="@/assets/img/kart_white.png" alt="order" />Add to Cart
              </button>
            </div>
          </div>
        </div>
    ...
    <template v-if="type == 'basket'">
      <div class="drop-cart__product" :key="item.productId">
        <a href="product.html" class="drop-cart__product-link">
          <img
            :src="item.productImg"
            alt="product"
            class="drop-cart__product-img"
          />
        </a>
        <div class="drop-cart__product-info">
          <a href="product.html" class="drop-cart__product-name">{{
            item.productName
          }}</a>

          <div class="drop-cart__product-price">
            <span class="drop-cart__product-count">{{ item.amount }} </span> x
            {{ item.productPrice }}
            <span class="drop-cart__product-sum">
